            ...
            <div class="form-group">
                <div class="form-group">
                    <div class="mx-auto" style="width: 500px;">
                        ...
                        <input class="formcontrol" type="text" id="nome" name="nome" placeholder="Nome do Livro" required autofocus>
                     </div>
                </div>
                <div class="form-group">
                    <div class="mx-auto" style="width: 500px;">
                        <label for="autor">Nome do autor</label>
                        <input class="formcontrol" type="text" id="autor" name="autor" placeholder="Autor do Livro" required>
                    </div>
                </div>
                <div class="form-group">
                    <div class="mx-auto" style="width: 500px;">
                        <label for="quantidade">Quantidade de páginas</label>
                        <input class="formcontrol" type="number" id="quantidade" name="quantidade" placeholder="Quantidade de Páginas" required>
                    </div>
                </div>
                <div class="form-group">
                    <div class="mx-auto" style="width: 500px;">
                        <label for="number">Valor unitário do livro</label>
                        <input class="formcontrol" type="text" id="preco" name="preco" placeholder="Preço do Livro" onkeypress="formatarMoeda();" required>
                    </div>
                </div>
                <div class="form-group">
                    <div class="mx-auto" style="width: 500px;">
                        <label for="date">Data de lançamento do livro</label>
                        <input class="formcontrol" type="date" id="data" name="data" placeholder="Data de Pulicação" required>
                    </div>
                </div>
                <div class="form-group">
